...
ratpack {
    ...
    handlers {
        ...
        prefix('api') {
            ...
            get('collections') { MongoService mongoService ->
            ...
            prefix('person') {
                ...
                get(':id') { MongoService mongoService ->
            ...
            prefix('image') {
                ...
                get(':filename') { MongoService mongoService ->
